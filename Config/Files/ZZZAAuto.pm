...
delete $Self->{'Customer::AuthModule::LDAP::Params'};
delete $Self->{'Customer::AuthModule::LDAP::SearchUserPw'};
delete $Self->{'Customer::AuthModule::LDAP::SearchUserDN'};
delete $Self->{'Customer::AuthModule::LDAP::UserAttr'};
delete $Self->{'Customer::AuthModule::LDAP::UID'};
delete $Self->{'Customer::AuthModule::LDAP::BaseDN'};
delete $Self->{'Customer::AuthModule::LDAP::Host'};
